...
export const metadata: Metadata = {
  title: "Eat for Life - Fine Dining Restaurant",
  description: "Experience exceptional fine dining at Eat for Life. Discover seasonal dishes crafted with premium ingredients and innovative techniques. Reserve your table today.",
  keywords: "fine dining, restaurant, gourmet cuisine, reservations, culinary excellence",
  metadataBase: new URL("https://eatforlife.com"),
  alternates: {
    canonical: "https://eatforlife.com"
  },
  openGraph: {
    title: "Eat for Life - Fine Dining Restaurant",
    description: "Experience exceptional fine dining with premium ingredients and innovative techniques",
    siteName: "Eat for Life",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766137144062-jxz0daft.jpg",
      alt: "Eat for Life Restaurant"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Eat for Life - Fine Dining Restaurant",
    description: "Experience exceptional fine dining cuisine",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766137144062-jxz0daft.jpg"]
  },
  robots: {
    index: true,
    follow: true
